...
from ..models.extras_single_image_request_resize_mode import ExtrasSingleImageRequestResizeMode
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExtrasSingleImageRequest")
...
class ExtrasSingleImageRequest:
    """
    Attributes:
        resize_mode (Union[Unset, ExtrasSingleImageRequestResizeMode]): Sets the resize mode: 0 to upscale by
            upscaling_resize amount, 1 to upscale up to upscaling_resize_h x upscaling_resize_w. Default:
            ExtrasSingleImageRequestResizeMode.VALUE_0.
    ...
    resize_mode: Union[Unset, ExtrasSingleImageRequestResizeMode] = ExtrasSingleImageRequestResizeMode.VALUE_0
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resize_mode: Union[Unset, ExtrasSingleImageRequestResizeMode]
        if isinstance(_resize_mode, Unset):
            resize_mode = UNSET
        else:
            resize_mode = ExtrasSingleImageRequestResizeMode(_resize_mode)
        ...
        extras_single_image_request = cls(
        ...
        extras_single_image_request.additional_properties = d
        return extras_single_image_request
