...
class ProgressResponse:
    ...
    Attributes:
        ...
        current_image (Union[Unset, str]): The current image in base64 format. opts.show_progress_every_n_steps is
            required for this to work.
        textinfo (Union[Unset, str]): Info text used by WebUI.
    """

    progress: float
    eta_relative: float
    state: "ProgressResponseState"
    current_image: Union[Unset, str] = UNSET
    textinfo: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        current_image = d.pop("current_image", UNSET)

        textinfo = d.pop("textinfo", UNSET)
