...
T = TypeVar("T", bound="CategoryMaskRequest")


@_attrs_define
class CategoryMaskRequest:
    """
    Attributes:
        category (str):
        input_image (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        category_mask_request.additional_properties = d
        return category_mask_request
