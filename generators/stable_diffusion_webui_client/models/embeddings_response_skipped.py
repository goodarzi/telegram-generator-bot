...
T = TypeVar("T", bound="EmbeddingsResponseSkipped")


@_attrs_define
class EmbeddingsResponseSkipped:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        embeddings_response_skipped = cls()
        ...
        embeddings_response_skipped.additional_properties = additional_properties
        return embeddings_response_skipped
