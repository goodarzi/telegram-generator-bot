...
from ...models.train_embedding_sdapi_v1_train_embedding_post_args import TrainEmbeddingSdapiV1TrainEmbeddingPostArgs
...
def _get_kwargs(
    *,
    body: TrainEmbeddingSdapiV1TrainEmbeddingPostArgs,
) -> Dict[str, Any]:
